...
namespace SystemHealthMonitor.WPF.ViewModels
{
    internal class NotificationViewModel
    {
        ...
        internal NotificationViewModel()
        {

        }
        internal NotificationViewModel(NotificationPipeListener listener, WindowsToastNotificationService windowsToastNotificationService)
        {
            _listener = listener;
